...
* @route '/livewire-e8f1bd29/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-e8f1bd29/upload-file',
...
* @route '/livewire-e8f1bd29/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-e8f1bd29/preview-file/{filename}',
