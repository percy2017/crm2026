...
* @see app/Http/Controllers/Admin/AdminUserController.php:19
* @route '/admin/users'
*/
...
* @see app/Http/Controllers/Admin/AdminUserController.php:35
* @route '/admin/users'
*/
...
* @see app/Http/Controllers/Admin/AdminUserController.php:51
...
* @see app/Http/Controllers/Admin/AdminUserController.php:60
...
* @see app/Http/Controllers/Admin/AdminUserController.php:81
* @route '/admin/users/{user}'
*/
