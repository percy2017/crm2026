...
* @route '/livewire-e8f1bd29/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-e8f1bd29/livewire.js',
...
* @route '/livewire-e8f1bd29/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-e8f1bd29/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-e8f1bd29/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-e8f1bd29/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
