...
/**
* @see \App\Http\Controllers\Admin\AdminCronJobController::runNow
* @see app/Http/Controllers/Admin/AdminCronJobController.php:119
* @route '/admin/cron-jobs/{cronJob}/run'
*/
export const runNow = (args: { cronJob: number | { id: number } } | [cronJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/cron-jobs/{cronJob}/run'
*/
runNow.url = (args: { cronJob: number | { id: number } } | [cronJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { cronJob: args }
    }
...
* @route '/admin/cron-jobs/{cronJob}/run'
*/
runNow.post = (args: { cronJob: number | { id: number } } | [cronJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: runNow.url(args, options),
    method: 'post',
})
...
* @route '/admin/cron-jobs/{cronJob}/run'
*/
const runNowForm = (args: { cronJob: number | { id: number } } | [cronJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/cron-jobs/{cronJob}/run'
*/
runNowForm.post = (args: { cronJob: number | { id: number } } | [cronJob: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: runNow.url(args, options),
    method: 'post',
})
...
const AdminCronJobController = { index, list, commands, store, update, destroy, toggle, runNow, logs }

export default AdminCronJobController