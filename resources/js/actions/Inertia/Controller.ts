...
*/
const Controller0b6b5a5ce14acc4a2d8557d0d5408f3d = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url(options),
    method: 'get',
})

Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.definition = {
    methods: ["get","head"],
    url: '/reverb-monitor',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/reverb-monitor'
*/
Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url = (options?: RouteQueryOptions) => {
    return Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.definition.url + queryParams(options)
}
...
* @route '/reverb-monitor'
*/
Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url(options),
    method: 'get',
})
...
* @route '/reverb-monitor'
*/
Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url(options),
    method: 'head',
})
...
* @route '/reverb-monitor'
*/
const Controller0b6b5a5ce14acc4a2d8557d0d5408f3dForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url(options),
    method: 'get',
})
...
* @route '/reverb-monitor'
*/
Controller0b6b5a5ce14acc4a2d8557d0d5408f3dForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url(options),
    method: 'get',
})
...
* @route '/reverb-monitor'
*/
Controller0b6b5a5ce14acc4a2d8557d0d5408f3dForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
Controller0b6b5a5ce14acc4a2d8557d0d5408f3d.form = Controller0b6b5a5ce14acc4a2d8557d0d5408f3dForm
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
const Controller = {
    ...
    '/reverb-monitor': Controller0b6b5a5ce14acc4a2d8557d0d5408f3d,
